...
validation]]. Based on [[heng_38-val][Heng Li's validation of build 38 using haploid/diploid
...
alternative haplotypes for resolving mapping issues. The [[fb_platinum-plot][FreeBayes calls]] look
...
#+LINK: heng_38-val https://github.com/lh3/bwa/blob/master/README-alt.md#preliminary-evaluation
...
#+LINK: fb_platinum-plot http://i.imgur.com/byZN0kY.png
...
in [[bcbio_38-val][the bcbio example pipeline documentation]]. We welcome re-analyses and
...
#+LINK: bcbio_38-val https://bcbio-nextgen.readthedocs.org/en/latest/contents/testing.html#human-genome-build-38
